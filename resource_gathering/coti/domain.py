...
from .adapter import ResourceGatheringAdapter
from .metric_keys import RESOURCE_GATHERING_ENV_METRIC_KEYS
...
def get_domain_spec() -> CoTIDomainSpec:
    return CoTIDomainSpec(
        ...
        adapter_cls=ResourceGatheringAdapter,
        state_item_key="_resource_state_before_turn",
        ...
        env_metric_keys=RESOURCE_GATHERING_ENV_METRIC_KEYS,
    )
